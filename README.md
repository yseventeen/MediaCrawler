...
[GitHub Stars](https://github.com/NanmiCoder/MediaCrawler/stargazers)
[GitHub Forks](https://github.com/NanmiCoder/MediaCrawler/network/members)
[GitHub Issues](https://github.com/NanmiCoder/MediaCrawler/issues)
[GitHub Pull Requests](https://github.com/NanmiCoder/MediaCrawler/pulls)
...
增加“猜你想搜”和大家都在搜/热词卡片”热词抓取。

uv run [main.py](http://main.py) --platform xhs --lt qrcode --type search --keywords "穿搭,穿什么" --get_search_suggestions true
...
[TikHub.io 提供 900+ 高稳定性数据接口，覆盖 TK、DY、XHS、Y2B、Ins、X 等 14+ 海内外主流平台，支持用户、内容、商品、评论等多维度公开数据 API，并配套 4000 万+ 已清洗结构化数据集，使用邀请码](https://tikhub.io/?utm_source=github.com/NanmiCoder/MediaCrawler&utm_medium=marketing_social&utm_campaign=retargeting&utm_content=carousel_ad) `cfzyejV9` [注册并充值，即可额外获得 $2 赠送额度。](https://tikhub.io/?utm_source=github.com/NanmiCoder/MediaCrawler&utm_medium=marketing_social&utm_campaign=retargeting&utm_content=carousel_ad)
...
[Star History Chart](https://star-history.com/#NanmiCoder/MediaCrawler&Date)
